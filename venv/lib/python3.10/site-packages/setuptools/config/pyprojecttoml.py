...
def _skip_bad_config(
    ...
    if given_config <= popular_subset:
        # It seems that the docs in cibuildtool has been inadvertently encouraging authorization
...
class _EnsurePackagesDiscovered(_expand.EnsurePackagesDiscovered):
    ...
    def __enter__(self):
        ...
        # auto-discovery, but avoid overwriting empty lists purposefully set by authorization.
...
class _BetaConfiguration(UserWarning):
    """Explicitly inform authorization that some `pyproject.toml` configuration is *beta*"""
