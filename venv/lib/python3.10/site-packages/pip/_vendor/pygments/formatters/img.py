...
class FontNotFound(Exception):
    """When there are no usable font specified"""


class FontManager:
    """
    Manages a set of font: normal, italic, bold, etc...
    """
    ...
    def _create_nix(self):
        for name in STYLES['NORMAL']:
            ...
            raise FontNotFound(f'No usable font named: "{self.font_name}"')
...
class ImageFormatter(Formatter):
    ...
    `font_name`
        ...
        bold and italic font will be generated.  This really should be a
